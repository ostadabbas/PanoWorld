...
VIDEO_RES_SIZE_INFO: dict[str, tuple[int, int]] = {
    ...
    "720robocasa": {"1,1": (720, 720), "4,3": (960, 720), "3,4": (720, 960), "16,9": (1280, 720), "9,16": (720, 1280)},
    # Panoramic (equirectangular) 2:1 aspect ratio resolutions
    "720pano": {"2,1": (704, 1408), "1,1": (960, 960)},
    "512pano": {"2,1": (512, 1024), "1,1": (512, 512)},
    "480pano": {"2,1": (480, 960), "1,1": (480, 480)},
    "384pano": {"2,1": (384, 768), "1,1": (384, 384)},
    "256pano": {"2,1": (256, 512), "1,1": (256, 256)},
    "256": {
        "1,1": (256, 256),
        "4,3": (320, 256),
        "3,4": (256, 320),
