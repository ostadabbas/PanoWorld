...
# Pano nets: SigLIP2 cross-attention (1152-dim) + ARGUS reference latent concat (16ch)
COSMOS_V1_2B_NET_PANO = copy.deepcopy(COSMOS_V1_2B_NET_MININET)
COSMOS_V1_2B_NET_PANO.extra_image_context_dim = 1152
COSMOS_V1_2B_NET_PANO.reference_channels = 16
COSMOS_V1_2B_NET_PANO.rope_grid_type = "equirectangular"

COSMOS_V1_14B_NET_PANO = copy.deepcopy(COSMOS_V1_14B_NET_MININET)
COSMOS_V1_14B_NET_PANO.extra_image_context_dim = 1152
COSMOS_V1_14B_NET_PANO.reference_channels = 16
COSMOS_V1_14B_NET_PANO.rope_grid_type = "equirectangular"
...
def register_net():
    ...
    cs.store(group="net", package="model.config.net", name="cosmos_v1_2B_pano", node=COSMOS_V1_2B_NET_PANO)
    cs.store(group="net", package="model.config.net", name="cosmos_v1_14B_pano", node=COSMOS_V1_14B_NET_PANO)
